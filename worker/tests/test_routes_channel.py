...
def test_jobs_without_channel_id_is_rejected():
    resp = client.post("/youtube/jobs", json={"story_id": "00000000-0000-0000-0000-000000000001"})
    assert resp.status_code == 422


def test_jobs_with_empty_channel_id_is_rejected():
    resp = client.post(
        "/youtube/jobs",
        json={"story_id": "00000000-0000-0000-0000-000000000001", "channel_id": ""},
    )
...
def test_jobs_with_unknown_channel_returns_400_and_names_it():
    with patch(
